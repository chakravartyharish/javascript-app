...
#                 sp_interaction_coeffs=[],r_interaction_coeffs=[]\
        ...
        self.nTime              = 10
        self.TimeResolution     = 1         # (e.g. 1e0)
        self.epsilon_rel        = 0.01
...
#                else :                     k_line+=",\n"
    ...
    def compare_red(self,mech_data_red,mp,verbose=0):
        ...
        for r in range(len(self.react.number)):
            for r_red in mech_data_red.react.number:
                if self.react.number[r]==r_red:
...
class Optim_param :
    def __init__(self, tsp, n_tspc, n_gen=20,n_ind=50, \
         ...
         optim_on_meth='False', Arrh_max_variation=10,nr=50,nb_r2opt=30):
